  ...
  return (
    <LegalLayout>
      ...
      <table>
        ...
        <tbody>
          <tr><td>アカウント情報</td><td>アカウント有効期間中＋削除請求受付後 30 日以内に削除（現状は contact@ 経由の手動対応）</td></tr>
          <tr><td>ユーザーコンテンツ（議事録等）</td><td>アカウント有効期間中＋削除請求受付後 30 日以内に削除（現状は contact@ 経由の手動対応）</td></tr>
      ...
      <h3>9.3 行使方法</h3>
      <ul>
        <li><strong>アカウント削除機能（自助実施）は今後実装予定です</strong>。それまでは下記窓口までご連絡いただければ、当方にて手動で対応いたします（データ削除権・忘れられる権利を含む全ての請求が対象）。</li>
        <li>
          各種請求の窓口:{' '}
          <strong>
