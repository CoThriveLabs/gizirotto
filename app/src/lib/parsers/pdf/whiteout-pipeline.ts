...
function fmtBox(b: PdfBox): string {
...
function logExcludeLabel(fb: FieldBox, decision: FieldLabelDecision): void {
  console.log(
 ...
 */
function logInkCell(fb: FieldBox, ink: InkResult, isLabel: boolean): void {
